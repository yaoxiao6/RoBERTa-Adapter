...
tokenizer_30000.save_pretrained('./domain_adapted_roberta') # NameError: name 'tokenizer' is not defined
...
# tokenizer_30000 = RobertaTokenizer.from_pretrained(DATPmodel)
...
# tokenizer_30000.save_pretrained('./DATP_Class_model')

# predictions = DATP_Class_trainer.predict(test_dataset)
